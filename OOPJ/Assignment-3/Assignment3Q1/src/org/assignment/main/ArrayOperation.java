...
public class ArrayOperation {
	...
	public static int showMenu() {
		...
		System.out.println("============================================================");
		System.out.print("Enter the Operation to perform on array : ");
		return sc.nextInt();
	}
	...
	public static void main(String[] args) {
		...
		int arr[] = null;
		int choice;
		while ((choice = ArrayOperation.showMenu()) != 8) {
			switch (choice) {
			...
			case 3:
				ArrayOperation.sumOfArrayElements(arr);
				break;

			case 4:
				ArrayOperation.avgOfArrayElements(arr);
				break;

			case 5:
				ArrayOperation.largestElementOfArray(arr);
				break;

			case 6:
				ArrayOperation.smallestElementOfaraay(arr);
				break;

			case 7:
				ArrayOperation.sortArrayElements(arr);
				break;
			}
