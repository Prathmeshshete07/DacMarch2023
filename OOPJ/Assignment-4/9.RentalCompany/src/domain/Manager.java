...
public class Manager {
	...
	public void printRentForAll() {
		...
		System.out.println(
				String.format("%-20s%-30s%-10s%-20s%-30s", "Make", "Car Model", "Year", "Rental Rate/Day", "Type"));
		for (Vehicle vehicle : vehicles) {
			String type = vehicle instanceof Car ? "Car" : (vehicle instanceof Truck ? "Truck" : "Motorcycle");
			System.out.println(String.format("%-20s%-30s%-10d%-20.2f%-30s", vehicle.getMake(), vehicle.getModel(),
